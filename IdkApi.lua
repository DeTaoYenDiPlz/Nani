...
function CheckLevelQuest()
	...
	if FirstSea then
		if (_G.FarmLevel and MyLevel == 1 or MyLevel <= 9) or (_G.SelectMob == "Bandit [Lv. 5]") then
			NameMob = "Bandit"
			NameQuest = "BanditQuest1"
			LevelQuest = 1
			CFrameMon = CFrame.new(1145, 17, 1634)
			CFrameQuestLevel = CFrame.new(1060, 17, 1547)
		elseif (_G.FarmLevel and MyLevel == 10 or MyLevel <= 14) or (_G.SelectMob == "Monkey [Lv. 14]") then
			NameMob = "Monkey"
			NameQuest = "JungleQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-1496, 39, 35)
			CFrameQuestLevel = CFrame.new(-1602, 37, 152)
		elseif (_G.FarmLevel and MyLevel == 15 or MyLevel <= 29) or (_G.SelectMob == "Gorilla [Lv. 20]") then
			NameMob = "Gorilla"
			NameQuest = "JungleQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-1237, 6, -486)
			CFrameQuestLevel = CFrame.new(-1602, 37, 152)
		elseif (_G.FarmLevel and MyLevel == 30 or MyLevel <= 39) or (_G.SelectMob == "Pirate [Lv. 35]") then
			NameMob = "Pirate"
			NameQuest = "BuggyQuest1"
			LevelQuest = 1
			CFrameMon = CFrame.new(-1115, 14, 3938)
			CFrameQuestLevel = CFrame.new(-1140, 5, 3828)
		elseif (_G.FarmLevel and MyLevel == 40 or MyLevel <= 59) or (_G.SelectMob == "Brute [Lv. 45]") then
			NameMob = "Brute"
			NameQuest = "BuggyQuest1"
			LevelQuest = 2
			CFrameMon = CFrame.new(-1145, 15, 4350)
			CFrameQuestLevel = CFrame.new(-1140, 5, 3828)
		elseif (_G.FarmLevel and MyLevel == 60 or MyLevel <= 74) or (_G.SelectMob == "Desert Bandit [Lv. 60]") then
			NameMob = "Desert Bandit"
			NameQuest = "DesertQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(932, 7, 4484)
			CFrameQuestLevel = CFrame.new(897, 7, 4388)
		elseif (_G.FarmLevel and MyLevel == 75 or MyLevel <= 89) or (_G.SelectMob == "Desert Officer [Lv. 70]") then
			NameMob = "Desert Officer"
			NameQuest = "DesertQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(1572, 10, 4373)
			CFrameQuestLevel = CFrame.new(897, 7, 4388)
		elseif (_G.FarmLevel and MyLevel == 90 or MyLevel <= 99) or (_G.SelectMob == "Snow Bandit [Lv. 90]") then
			NameMob = "Snow Bandit"
			NameQuest = "SnowQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(1289, 150, -1442)
			CFrameQuestLevel = CFrame.new(1386, 87, -1297)
		elseif (_G.FarmLevel and MyLevel == 100 or MyLevel <= 119) or (_G.SelectMob == "Snowman [Lv. 100]") then
			NameMob = "Snowman"
			NameQuest = "SnowQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(1289, 150, -1442)
			CFrameQuestLevel = CFrame.new(1386, 87, -1297)
		elseif (_G.FarmLevel and MyLevel == 120 or MyLevel <= 149) or (_G.SelectMob == "Chief Petty Officer [Lv. 120]") then
			NameMob = "Chief Petty Officer"
			NameQuest = "MarineQuest2"
			LevelQuest = 1
			CFrameMon = CFrame.new(-4855, 23, 4308)
			CFrameQuestLevel = CFrame.new(-5036, 29, 4325)
		elseif (_G.FarmLevel and MyLevel == 150 or MyLevel <= 174) or (_G.SelectMob == "Sky Bandit [Lv. 150]") then
			NameMob = "Sky Bandit"
			NameQuest = "SkyQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-4981, 278, -2830)
			CFrameQuestLevel = CFrame.new(-4842, 718, -2623)
		elseif (_G.FarmLevel and MyLevel == 175 or MyLevel <= 189) or (_G.SelectMob == "Dark Master [Lv. 175]") then
			NameMob = "Dark Master"
			NameQuest = "SkyQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-5250, 389, -2272)
			CFrameQuestLevel = CFrame.new(-4842, 718, -2623)
		elseif (_G.FarmLevel and MyLevel == 190 or MyLevel <= 209) or (_G.SelectMob == "Prisoner [Lv. 190]") then
			NameMob = "Prisoner"
			NameQuest = "PrisonerQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(5411, 96, 690)
			CFrameQuestLevel = CFrame.new(5308, 2, 474)
		elseif (_G.FarmLevel and MyLevel == 210 or MyLevel <= 249) or (_G.SelectMob == "Dangerous Prisoner [Lv. 210]") then
			NameMob = "Dangerous Prisoner"
			NameQuest = "PrisonerQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(5411, 96, 690)
			CFrameQuestLevel = CFrame.new(5308, 2, 474)
		elseif (_G.FarmLevel and MyLevel == 250 or MyLevel <= 274) or (_G.SelectMob == "Toga Warrior [Lv. 250]") then
		...
		elseif (_G.FarmLevel and MyLevel == 275 or MyLevel <= 299) or (_G.SelectMob == "Gladiator [Lv. 275]") then
			NameMob = "Gladiator"
			NameQuest = "ColosseumQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-1385.5233154296875, 7.468349456787109, -3163.066650390625)
			CFrameQuestLevel = CFrame.new(-1576, 8, -2985)
		elseif (_G.FarmLevel and MyLevel == 300 or MyLevel <= 329) or (_G.SelectMob == "Military Soldier [Lv. 300]") then
			NameMob = "Military Soldier"
			NameQuest = "MagmaQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-5408, 11, 8447)
			CFrameQuestLevel = CFrame.new(-5316, 12, 8517)
		elseif (_G.FarmLevel and MyLevel == 330 or MyLevel <= 374) or (_G.SelectMob == "Military Spy [Lv. 325]") then
			NameMob = "Military Spy"
			NameQuest = "MagmaQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-5815, 84, 8820)
			CFrameQuestLevel = CFrame.new(-5316, 12, 8517)
		elseif (_G.FarmLevel and MyLevel == 375 or MyLevel <= 399) or (_G.SelectMob == "Fishman Warrior [Lv. 375]") then
			NameMob = "Fishman Warrior"
			NameQuest = "FishmanQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(60859, 19, 1501)
			CFrameQuestLevel = CFrame.new(61123, 19, 1569)
		elseif (_G.FarmLevel and MyLevel == 400 or MyLevel <= 449) or (_G.SelectMob == "Fishman Commando [Lv. 400]") then
			NameMob = "Fishman Commando"
			NameQuest = "FishmanQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(61891, 19, 1470)
			CFrameQuestLevel = CFrame.new(61123, 19, 1569)
		elseif (_G.FarmLevel and MyLevel == 450 or MyLevel <= 474) or (_G.SelectMob == "God's Guard [Lv. 450]") then
			NameMob = "God's Guard"
			NameQuest = "SkyExp1Quest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-4698, 845, -1912)
			CFrameQuestLevel = CFrame.new(-4722, 845, -1954)
		elseif (_G.FarmLevel and MyLevel == 475 or MyLevel <= 524) or (_G.SelectMob == "Shanda [Lv. 475]") then
			NameMob = "Shanda"
			NameQuest = "SkyExp1Quest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-7685, 5567, -502)
			CFrameQuestLevel = CFrame.new(-7862, 5546, -380)
		elseif (_G.FarmLevel and MyLevel == 525 or MyLevel <= 549) or (_G.SelectMob == "Royal Squad [Lv. 525]") then
			NameMob = "Royal Squad"
			NameQuest = "SkyExp2Quest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-7670, 5607, -1460)
			CFrameQuestLevel = CFrame.new(-7904, 5636, -1412)
		elseif (_G.FarmLevel and MyLevel == 550 or MyLevel <= 624) or (_G.SelectMob == "Royal Soldier [Lv. 550]") then
			NameMob = "Royal Soldier"
			NameQuest = "SkyExp2Quest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-7828, 5607, -1744)
			CFrameQuestLevel = CFrame.new(-7904, 5636, -1412)
		elseif (_G.FarmLevel and MyLevel == 625 or MyLevel <= 649) or (_G.SelectMob == "Galley Pirate [Lv. 625]") then
			NameMob = "Galley Pirate"
			NameQuest = "FountainQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(5589, 45, 3996)
			CFrameQuestLevel = CFrame.new(5256, 39, 4050)
		elseif (_G.FarmLevel and MyLevel >= 650) or (_G.SelectMob == "Galley Captain [Lv. 650]") then
	...
	if SecondSea then
		if (_G.FarmLevel and MyLevel == 700 or MyLevel <= 724) or (_G.SelectMob == "Raider [Lv. 700]") then
			NameMob = "Raider"
			NameQuest = "Area1Quest"
			LevelQuest = 1
			CFrameQuestLevel = CFrame.new(-425, 73, 1837)
			CFrameMon = CFrame.new(-746, 39, 2390)
		elseif (_G.FarmLevel and MyLevel == 725 or MyLevel <= 774) or (_G.SelectMob == "Mercenary [Lv. 725]") then
			NameMob = "Mercenary"
			NameQuest = "Area1Quest"
			LevelQuest = 2
			CFrameQuestLevel = CFrame.new(-425, 73, 1837)
			CFrameMon = CFrame.new(-874, 141, 1312)
		elseif (_G.FarmLevel and MyLevel == 775 or MyLevel <= 799) or (_G.SelectMob == "Swan Pirate [Lv. 775]") then
			NameMob = "Swan Pirate"
			NameQuest = "Area2Quest"
			LevelQuest = 1
			CFrameQuestLevel = CFrame.new(634, 73, 918)
			CFrameMon = CFrame.new(878, 122, 1235)
		elseif (_G.FarmLevel and MyLevel == 800 or MyLevel <= 874) or (_G.SelectMob == "Factory Staff [Lv. 800]") then
			NameMob = "Factory Staff"
			NameQuest = "Area2Quest"
			LevelQuest = 2
			CFrameQuestLevel = CFrame.new(634, 73, 918)
			CFrameMon = CFrame.new(295, 73, -56)
		elseif (_G.FarmLevel and MyLevel == 875 or MyLevel <= 899) or (_G.SelectMob == "Marine Lieutenant [Lv. 875]") then
			NameMob = "Marine Lieutenant"
			NameQuest = "MarineQuest3"
			LevelQuest = 1
			CFrameMon = CFrame.new(-2806, 73, -3038)
			CFrameQuestLevel = CFrame.new(-2443, 73, -3219)
		elseif (_G.FarmLevel and MyLevel == 900 or MyLevel <= 949) or (_G.SelectMob == "Marine Captain [Lv. 900]") then
			NameMob = "Marine Captain"
			NameQuest = "MarineQuest3"
			LevelQuest = 2
			CFrameMon = CFrame.new(-1869, 73, -3320)
			CFrameQuestLevel = CFrame.new(-2443, 73, -3219)
		elseif (_G.FarmLevel and MyLevel == 950 or MyLevel <= 974) or (_G.SelectMob == "Zombie [Lv. 950]") then
			NameMob = "Zombie"
			NameQuest = "ZombieQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-5736, 126, -728)
			CFrameQuestLevel = CFrame.new(-5494, 49, -795)
		elseif (_G.FarmLevel and MyLevel == 975 or MyLevel <= 999) or (_G.SelectMob == "Vampire [Lv. 975]") then
			NameMob = "Vampire"
			NameQuest = "ZombieQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-6033, 7, -1317)
			CFrameQuestLevel = CFrame.new(-5494, 49, -795)
		elseif (_G.FarmLevel and MyLevel == 1000 or MyLevel <= 1049) or (_G.SelectMob == "Snow Trooper [Lv. 1000]") then
			NameMob = "Snow Trooper"
			NameQuest = "SnowMountainQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(478, 402, -5362)
			CFrameQuestLevel = CFrame.new(605, 402, -5371)
		elseif (_G.FarmLevel and MyLevel == 1050 or MyLevel <= 1099) or (_G.SelectMob == "Winter Warrior [Lv. 1050]") then
			NameMob = "Winter Warrior"
			NameQuest = "SnowMountainQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(1157, 430, -5188)
			CFrameQuestLevel = CFrame.new(605, 402, -5371)
		elseif (_G.FarmLevel and MyLevel == 1100 or MyLevel <= 1124) or (_G.SelectMob == "Lab Subordinate [Lv. 1100]") then
			NameMob = "Lab Subordinate"
			NameQuest = "IceSideQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-5782, 42, -4484)
			CFrameQuestLevel = CFrame.new(-6060, 16, -4905)
		elseif (_G.FarmLevel and MyLevel == 1125 or MyLevel <= 1174) or (_G.SelectMob == "Horned Warrior [Lv. 1125]") then
			NameMob = "Horned Warrior"
			NameQuest = "IceSideQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-6406, 24, -5805)
			CFrameQuestLevel = CFrame.new(-6060, 16, -4905)
		elseif (_G.FarmLevel and MyLevel == 1175 or MyLevel <= 1199) or (_G.SelectMob == "Magma Ninja [Lv. 1175]") then
			NameMob = "Magma Ninja"
			NameQuest = "FireSideQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-5428, 78, -5959)
			CFrameQuestLevel = CFrame.new(-5430, 16, -5295)
		elseif (_G.FarmLevel and MyLevel == 1200 or MyLevel <= 1249) or (_G.SelectMob == "Lava Pirate [Lv. 1200]") then
			NameMob = "Lava Pirate"
			NameQuest = "FireSideQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-5270, 42, -4800)
			CFrameQuestLevel = CFrame.new(-5430, 16, -5295)
		elseif (_G.FarmLevel and MyLevel == 1250 or MyLevel <= 1274) or (_G.SelectMob == "Ship Deckhand [Lv. 1250]") then
			NameMob = "Ship Deckhand"
			NameQuest = "ShipQuest1"
			LevelQuest = 1
			CFrameMon = CFrame.new(1198, 126, 33031)
			CFrameQuestLevel = CFrame.new(1038, 125, 32913)
		elseif (_G.FarmLevel and MyLevel == 1275 or MyLevel <= 1299) or (_G.SelectMob == "Ship Engineer [Lv. 1275]") then
			NameMob = "Ship Engineer"
			NameQuest = "ShipQuest1"
			LevelQuest = 2
			CFrameMon = CFrame.new(918, 44, 32787)
			CFrameQuestLevel = CFrame.new(1038, 125, 32913)
		elseif (_G.FarmLevel and MyLevel == 1300 or MyLevel <= 1324) or (_G.SelectMob == "Ship Steward [Lv. 1300]") then
			NameMob = "Ship Steward"
			NameQuest = "ShipQuest2"
			LevelQuest = 1
			CFrameMon = CFrame.new(915, 130, 33419)
			CFrameQuestLevel = CFrame.new(969, 125, 33245)
		elseif (_G.FarmLevel and MyLevel == 1325 or MyLevel <= 1349) or (_G.SelectMob == "Ship Officer [Lv. 1325]") then
			NameMob = "Ship Officer"
			NameQuest = "ShipQuest2"
			LevelQuest = 2
			CFrameMon = CFrame.new(916, 181, 33335)
			CFrameQuestLevel = CFrame.new(969, 125, 33245)
		elseif (_G.FarmLevel and MyLevel == 1350 or MyLevel <= 1374) or (_G.SelectMob == "Arctic Warrior [Lv. 1350]") then
			NameMob = "Arctic Warrior"
			NameQuest = "FrostQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(6038, 29, -6231)
			CFrameQuestLevel = CFrame.new(5669, 28, -6482)
		elseif (_G.FarmLevel and MyLevel == 1375 or MyLevel <= 1424) or (_G.SelectMob == "Snow Lurker [Lv. 1375]") then
			NameMob = "Snow Lurker"
			NameQuest = "FrostQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(5560, 42, -6826)
			CFrameQuestLevel = CFrame.new(5669, 28, -6482)
		elseif (_G.FarmLevel and MyLevel == 1425 or MyLevel <= 1449) or (_G.SelectMob == "Sea Soldier [Lv. 1425]") then
			NameMob = "Sea Soldier"
			NameQuest = "ForgottenQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-3022, 16, -9722)
			CFrameQuestLevel = CFrame.new(-3054, 237, -10148)
		elseif (_G.FarmLevel and MyLevel >= 1450) or (_G.SelectMob == "Water Fighter [Lv. 1450]") then
	...
	if ThirdSea then
		if (_G.FarmLevel and MyLevel == 1500 or MyLevel <= 1524) or (_G.SelectMob == "Pirate Millionaire [Lv. 1500]") then
			NameMob = "Pirate Millionaire"
			NameQuest = "PiratePortQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-373, 75, 5550)
			CFrameQuestLevel = CFrame.new(-288, 44, 5576)
		elseif (_G.FarmLevel and MyLevel == 1525 or MyLevel <= 1574) or (_G.SelectMob == "Pistol Billionaire [Lv. 1525]") then
			NameMob = "Pistol Billionaire"
			NameQuest = "PiratePortQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-469, 74, 5904)
			CFrameQuestLevel = CFrame.new(-288, 44, 5576)
		elseif (_G.FarmLevel and MyLevel == 1575 or MyLevel <= 1599) or (_G.SelectMob == "Dragon Crew Warrior [Lv. 1575]") then
			NameMob = "Dragon Crew Warrior"
			NameQuest = "AmazonQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(6339, 52, -1213)
			CFrameQuestLevel = CFrame.new(5835, 52, -1105)
		elseif (_G.FarmLevel and MyLevel == 1600 or MyLevel <= 1624) or (_G.SelectMob == "Dragon Crew Archer [Lv. 1600]") then
			NameMob = "Dragon Crew Archer"
			NameQuest = "AmazonQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(6594, 383, 139)
			CFrameQuestLevel = CFrame.new(5835, 52, -1105)
		elseif (_G.FarmLevel and MyLevel == 1625 or MyLevel <= 1649) or (_G.SelectMob == "Female Islander [Lv. 1625]") then
			NameMob = "Female Islander"
			NameQuest = "AmazonQuest2"
			LevelQuest = 1
			CFrameMon = CFrame.new(5308, 819, 1047)
			CFrameQuestLevel = CFrame.new(5443, 602, 751)
		elseif (_G.FarmLevel and MyLevel == 1650 or MyLevel <= 1699) or (_G.SelectMob == "Giant Islander [Lv. 1650]") then
			NameMob = "Giant Islander"
			NameQuest = "AmazonQuest2"
			LevelQuest = 2
			CFrameMon = CFrame.new(4951, 602, -68)
			CFrameQuestLevel = CFrame.new(5443, 602, 751)
		elseif (_G.FarmLevel and MyLevel == 1700 or MyLevel <= 1724) or (_G.SelectMob == "Marine Commodore [Lv. 1700]") then
			NameMob = "Marine Commodore"
			NameQuest = "MarineTreeIsland"
			LevelQuest = 1
			CFrameMon = CFrame.new(2447, 73, -7470)
			CFrameQuestLevel = CFrame.new(2180, 29, -6737)
		elseif (_G.FarmLevel and MyLevel == 1725 or MyLevel <= 1774) or (_G.SelectMob == "Marine Rear Admiral [Lv. 1725]") then
			NameMob = "Marine Rear Admiral"
			NameQuest = "MarineTreeIsland"
			LevelQuest = 2
			CFrameMon = CFrame.new(3671, 161, -6932)
			CFrameQuestLevel = CFrame.new(2180, 29, -6737)
		elseif (_G.FarmLevel and MyLevel == 1775 or MyLevel <= 1800) or (_G.SelectMob == "Fishman Raider [Lv. 1775]") then
			NameMob = "Fishman Raider"
			NameQuest = "DeepForestIsland3"
			LevelQuest = 1
			CFrameMon = CFrame.new(-10560, 332, -8466)
			CFrameQuestLevel = CFrame.new(-10584, 332, -8758)
		elseif (_G.FarmLevel and MyLevel == 1800 or MyLevel <= 1824) or (_G.SelectMob == "Fishman Captain [Lv. 1800]") then
			NameMob = "Fishman Captain"
			NameQuest = "DeepForestIsland3"
			LevelQuest = 2
			CFrameMon = CFrame.new(-10993, 332, -8940)
			CFrameQuestLevel = CFrame.new(-10584, 332, -8758)
		elseif (_G.FarmLevel and MyLevel == 1825 or MyLevel <= 1849) or (_G.SelectMob == "Forest Pirate [Lv. 1825]") then
			NameMob = "Forest Pirate"
			NameQuest = "DeepForestIsland"
			LevelQuest = 1
			CFrameMon = CFrame.new(-13479, 333, -7905)
			CFrameQuestLevel = CFrame.new(-13232, 333, -7627)
		elseif (_G.FarmLevel and MyLevel == 1850 or MyLevel <= 1899) or (_G.SelectMob == "Mythological Pirate [Lv. 1850]") then
			NameMob = "Mythological Pirate"
			NameQuest = "DeepForestIsland"
			LevelQuest = 2
			CFrameMon = CFrame.new(-13545, 470, -6917)
			CFrameQuestLevel = CFrame.new(-13232, 333, -7627)
		elseif (_G.FarmLevel and MyLevel == 1900 or MyLevel <= 1924) or (_G.SelectMob == "Jungle Pirate [Lv. 1900]") then
			NameMob = "Jungle Pirate"
			NameQuest = "DeepForestIsland2"
			LevelQuest = 1
			CFrameMon = CFrame.new(-12107, 332, -10549)
			CFrameQuestLevel = CFrame.new(-12684, 391, -9902)
		elseif (_G.FarmLevel and MyLevel == 1925 or MyLevel <= 1974) or (_G.SelectMob == "Musketeer Pirate [Lv. 1925]") then
			NameMob = "Musketeer Pirate"
			NameQuest = "DeepForestIsland2"
			LevelQuest = 2
			CFrameMon = CFrame.new(-13286, 392, -9769)
			CFrameQuestLevel = CFrame.new(-12684, 391, -9902)
		elseif (_G.FarmLevel and MyLevel == 1975 or MyLevel <= 1999) or (_G.SelectMob == "Reborn Skeleton [Lv. 1975]") then
			NameMob = "Reborn Skeleton"
			NameQuest = "HauntedQuest1"
			LevelQuest = 1
			CFrameMon = CFrame.new(-8760, 142, 6039)
			CFrameQuestLevel = CFrame.new(-9482, 142, 5567)
		elseif (_G.FarmLevel and MyLevel == 2000 or MyLevel <= 2024) or (_G.SelectMob == "Living Zombie [Lv. 2000]") then
			NameMob = "Living Zombie"
			NameQuest = "HauntedQuest1"
			LevelQuest = 2
			CFrameMon = CFrame.new(-10144, 140, 5932)
			CFrameQuestLevel = CFrame.new(-9482, 142, 5567)
		elseif (_G.FarmLevel and MyLevel == 2025 or MyLevel <= 2049) or (_G.SelectMob == "Demonic Soul [Lv. 2025]") then
			NameMob = "Demonic Soul"
			NameQuest = "HauntedQuest2"
			LevelQuest = 1
			CFrameMon = CFrame.new(-9507, 172, 6158)
			CFrameQuestLevel = CFrame.new(-9513, 172, 6079)
		elseif (_G.FarmLevel and MyLevel == 2050 or MyLevel <= 2074) or (_G.SelectMob == "Posessed Mummy [Lv. 2050]") then
			NameMob = "Posessed Mummy"
			NameQuest = "HauntedQuest2"
			LevelQuest = 2
			CFrameMon = CFrame.new(-9577, 6, 6223)
			CFrameQuestLevel = CFrame.new(-9513, 172, 6079)
		elseif (_G.FarmLevel and MyLevel == 2075 or MyLevel <= 2099) or (_G.SelectMob == "Peanut Scout [Lv. 2075]") then
			NameMob = "Peanut Scout"
			NameQuest = "NutsIslandQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-2124, 123, -10435)
			CFrameQuestLevel = CFrame.new(-2104, 38, -10192)
		elseif (_G.FarmLevel and MyLevel == 2100 or MyLevel <= 2124) or (_G.SelectMob == "Peanut President [Lv. 2100]") then
			NameMob = "Peanut President"
			NameQuest = "NutsIslandQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-2124, 123, -10435)
			CFrameQuestLevel = CFrame.new(-2104, 38, -10192)
		elseif (_G.FarmLevel and MyLevel == 2125 or MyLevel <= 2149) or (_G.SelectMob == "Ice Cream Chef [Lv. 2125]") then
			NameMob = "Ice Cream Chef"
			NameQuest = "IceCreamIslandQuest"
			LevelQuest = 1
			CFrameMon = CFrame.new(-641, 127, -11062)
			CFrameQuestLevel = CFrame.new(-822, 66, -10965)
		elseif (_G.FarmLevel and MyLevel == 2150 or MyLevel <= 2199) or (_G.SelectMob == "Ice Cream Commander [Lv. 2150]") then
			NameMob = "Ice Cream Commander"
			NameQuest = "IceCreamIslandQuest"
			LevelQuest = 2
			CFrameMon = CFrame.new(-641, 127, -11062)
			CFrameQuestLevel = CFrame.new(-822, 66, -10965)
		elseif (_G.FarmLevel and MyLevel == 2200 or MyLevel <= 2224) or (_G.SelectMob == "Cookie Crafter [Lv. 2200]") then
			NameMob = "Cookie Crafter"
			NameQuest = "CakeQuest1"
			LevelQuest = 1
			CFrameMon = CFrame.new(-2365, 38, -12099)
			CFrameQuestLevel = CFrame.new(-2020, 38, -12025)
		elseif (_G.FarmLevel and MyLevel == 2225 or MyLevel <= 2249) or (_G.SelectMob == "Cake Guard [Lv. 2225]") then
			NameMob = "Cake Guard"
			NameQuest = "CakeQuest1"
			LevelQuest = 2
			CFrameMon = CFrame.new(-1651, 38, -12308)
			CFrameQuestLevel = CFrame.new(-2020, 38, -12025)
		elseif (_G.FarmLevel and MyLevel == 2250 or MyLevel <= 2274) or (_G.SelectMob == "Baking Staff [Lv. 2250]") then
			NameMob = "Baking Staff"
			NameQuest = "CakeQuest2"
			LevelQuest = 1
			CFrameMon = CFrame.new(-1870, 38, -12938)
			CFrameQuestLevel = CFrame.new(-1926, 38, -12850)
		elseif (_G.FarmLevel and MyLevel == 2275 or MyLevel <= 2300) or (_G.SelectMob == "Head Baker [Lv. 2275]") then
			NameMob = "Head Baker"
			NameQuest = "CakeQuest2"
			LevelQuest = 2
			CFrameMon = CFrame.new(-1926, 88, -12850)
			CFrameQuestLevel = CFrame.new(-1926, 38, -12850)
		elseif (_G.FarmLevel and MyLevel == 2300 or MyLevel <= 2324) or (_G.SelectMob == "Cocoa Warrior [Lv. 2300]") then
		...
		elseif (_G.FarmLevel and MyLevel == 2325 or MyLevel <= 2349) or (_G.SelectMob == "Chocolate Bar Battler [Lv. 2325]") then
			NameMob = "Chocolate Bar Battler"
			NameQuest = "ChocQuest1"
			LevelQuest = 2
			CFrameMon = CFrame.new(620.6344604492188, 78.93644714355469, -12581.369140625)
			CFrameQuestLevel = CFrame.new(231.75, 23.9003029, -12200.292, -1, 0, 0, 0, 1, 0, 0, 0, -1)
		elseif (_G.FarmLevel and MyLevel == 2350 or MyLevel <= 2374) or (_G.SelectMob == "Sweet Thief [Lv. 2350]") then
			NameMob = "Sweet Thief"
		...
		elseif (_G.FarmLevel and MyLevel == 2375 or MyLevel <= 2399) or (_G.SelectMob == "Candy Rebel [Lv. 2375]") then
			NameMob = "Candy Rebel"
			NameQuest = "ChocQuest2"
			LevelQuest = 2
		...
		elseif (_G.FarmLevel and MyLevel == 2400 or MyLevel <= 2424) or (_G.SelectMob == "Candy Pirate [Lv. 2400]") then
		...
		elseif (_G.FarmLevel and MyLevel == 2425 or MyLevel <= 2449) or (_G.SelectMob == "Snow Demon [Lv. 2425]") then
			NameMob = "Snow Demon"
			NameQuest = "CandyQuest1"
			LevelQuest = 2
			CFrameMon = CFrame.new(-844.35546875, 138.32464599609375, -14496.455078125)
			CFrameQuestLevel = CFrame.new(-1147.6552734375, 17.82676887512207, -14447.7099609375)
		elseif (_G.FarmLevel and MyLevel == 2450 or MyLevel <= 2474) or (_G.SelectMob == "Isle Outlaw [Lv. 2450]") then
			NameMob = "Isle Outlaw"
		...
		elseif (_G.FarmLevel and MyLevel == 2475 or MyLevel <= 2499) or (_G.SelectMob == "Island Boy [Lv. 2475]") then
			NameMob = "Island Boy"
			NameQuest = "TikiQuest1"
			LevelQuest = 2
			CFrameMon = CFrame.new(-16749.416015625, 125.9124755859375, -272.1277770996094)
			CFrameQuestLevel = CFrame.new(-16545.927734375, 55.68635559082031, -173.01036071777344)
		elseif (_G.FarmLevel and MyLevel == 2500 or MyLevel <= 2524) or (_G.SelectMob == "Sun-kissed Warrior [Lv. 2500]") then
			NameMob = "Sun-kissed Warrior"
		...
		elseif (_G.FarmLevel and MyLevel == 2525 or MyLevel <= 2549) or (_G.SelectMob == "Isle Champion [Lv. 2525]") then
			NameMob = "Isle Champion"
			NameQuest = "TikiQuest2"
			LevelQuest = 2
			CFrameMon = CFrame.new(-16743.2421875, 137.21322631835938, 1148.2789306640625)
			CFrameQuestLevel = CFrame.new(-16538.888671875, 55.68632888793945, 1051.730712890625)
		elseif (_G.FarmLevel and MyLevel == 2550 or MyLevel <= 2574) or (_G.SelectMob == "Serpent Hunter [Lv. 2550]") then
			NameMob = "Serpent Hunter"
		...
		elseif (_G.FarmLevel and MyLevel >= 2575) or (_G.SelectMob == "Skull Slayer [Lv. 2575]") then
			NameMob = "Skull Slayer"
			NameQuest = "TikiQuest3"
			LevelQuest = 1
			CFrameMon = CFrame.new(-16585.32421875, 102.54767608642578, 1674.416259765625)
			CFrameQuestLevel = CFrame.new(-16665.1973, 104.56427, 1579.677, 0.70395112, 0, 0.710248411, 0, 1, 0, -0.710248411, 0, 0.70395112)
